...
class League(BaseModel):
    ...
    most_championships = models.ForeignKey(Team,
    on_delete=models.DO_NOTHING,related_name="most_championships_team_id", blank=True, null=False)
    current_champion = models.ForeignKey(Team,
    on_delete=models.DO_NOTHING,related_name="champion_team_id", blank=True, null=False)
    most_appearances = models.ForeignKey(Player,
    on_delete=models.DO_NOTHING, related_name="most_appearances_player_id", blank=True, null=False)
